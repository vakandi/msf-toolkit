...
if [ "$CONT" = "y" ]; then
  ...
  apt-mark hold openssl postgresql openssl-1.1 openssl-1.1-static openssl-static openssl-tool openssl1.1-tool sslscan libgcrypt libpcap libxml2 libcrypt
